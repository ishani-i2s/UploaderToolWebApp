...
//     const config = {
//         authorizationUrl:"https://culligan-sandbx.ifs.cloud:48080/openid-connect-provider/idp/authorization",
//         clientId:"ee9f3f14-aad0-42a5-8b78-be97233ba9e4",
//         redirectUri:"http://localhost:3000/",
//         responseType:"code",
//         scope:"openid microprofile-jwt",
//         state:generateState(),
...
//           'code': code,
//           'state': state,
//           'client_id': 'ee9f3f14-aad0-42a5-8b78-be97233ba9e4',
//           'grant_type': 'authorization_code',
//           'redirect_uri': 'http://localhost:3000/',
//         };
//         for (var property in details) {
...
//         fetch('/openid-connect-provider/idp/token', {
//           method: 'POST',
//           headers: {
//             'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8',
//             'Access-Control-Allow-Origin': '*'
